    ...
    <div className='p-3 flex items-center rounded-[20px] bg-[#F7F7F7]/2 z-40 w-full bg-[#FFFFFF]/5 overlay relative'>
      <div className='w-full flex items-center gap-4'>
        ...
        <input
          ...
          className='placeholder-[#F7F7F7]/25 placeholder:font-semibold bg-transparent focus:placeholder-[#F7F7F7]/70 flex-1 w-full outline-hidden border-none transition-all duration-500 text-[#F7F7F7]'
        />
      </div>
    </div>
  );
